      ...
      <div class="row gy-4">
        <div class="col-md-6 col-lg-4">
          <div class="post-entry" data-aos="fade-up" data-aos-delay="100">
            <a href="#" class="thumb d-block"><img src="{{ asset('assets/img/img_h_4.jpg') }}" alt="Image"
        ...
        <div class="col-md-6 col-lg-4">
          <div class="post-entry" data-aos="fade-up" data-aos-delay="200">
            <a href="#" class="thumb d-block"><img src="{{ asset('assets/img/img_h_2.jpg') }}" alt="Image"
                class="img-fluid rounded"></a>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="post-entry" data-aos="fade-up" data-aos-delay="300">
            <a href="#" class="thumb d-block"><img src="{{ asset('assets/img/img_h_3.jpg') }}" alt="Image"
                class="img-fluid rounded"></a>
          ...
          <div class="swiper init-swiper">
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="testimonial mx-auto">
                  <figure class="img-wrap">
                    <img src="{{ asset('assets/img/testimonials/testimonials-1.jpg') }}" alt="Image"
                      class="img-fluid">
                  </figure>
              ...
              <div class="swiper-slide">
                <div class="testimonial mx-auto">
                  <figure class="img-wrap">
                    <img src="{{ asset('assets/img/testimonials/testimonials-2.jpg') }}" alt="Image"
                      class="img-fluid">
                  </figure>
              ...
              <div class="swiper-slide">
                <div class="testimonial mx-auto">
                  <figure class="img-wrap">
                    <img src="{{ asset('assets/img/testimonials/testimonials-3.jpg') }}" alt="Image"
                      class="img-fluid">
                  </figure>
