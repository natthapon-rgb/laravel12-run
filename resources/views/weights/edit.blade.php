<x-layouts.weight title="แก้ไขข้อมูลน้ำหนัก">

    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">✏️ แก้ไขข้อมูลน้ำหนัก</h4>
                    ...
                    <form action="{{ route('weights.update', $weight->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date"
                                   ...
                                   value="{{ old('recorded_date', $weight->recorded_date->format('Y-m-d')) }}">
                            @error('recorded_date')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number"
                                   ...
                                   value="{{ old('weight_kg', $weight->weight_kg) }}">
                            @error('weight_kg')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="note"
                                      ...
                                      rows="3">{{ old('note', $weight->note) }}</textarea>
                            @error('note')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
